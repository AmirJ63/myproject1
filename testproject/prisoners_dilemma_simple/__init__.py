...
class ResultsWaitPage(WaitPage):
    ...
    if player_1.defect:
        if player_2.defect:
            ...
            player_1.payoff = Constants.payoff_cooperate_defect_high
            player_2.payoff = Constants.payoff_cooperate_defect_low
    else:
        if player_2.defect:
            player_2.payoff = Constants.payoff_cooperate_defect_low
            player_2.payoff = Constants.payoff_cooperate_defect_high
        else:
